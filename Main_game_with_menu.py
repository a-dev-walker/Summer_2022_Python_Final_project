                    ...
                    if player_turn == 0:
                        ...
                        if column_validity_check(backend_board,mouse_col):
                            ...
                            if winning_move(backend_board, 1):
                                label = MY_FONT.render("Red wins!!", 1, RED_COLOR)
                                end_game = True
                        ...
                        if column_validity_check(backend_board,mouse_col):
                            ...
                            if winning_move(backend_board, 2):
                                label = MY_FONT.render("Black wins!!", 1, BLACK_COLOR)
                                end_game = True
...
menu.add.text_input ("Red:", default = 'Player 1')
menu.add.text_input ("Black:", default = 'Player 2')
